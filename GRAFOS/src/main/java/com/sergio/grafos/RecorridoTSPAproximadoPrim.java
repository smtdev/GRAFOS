...
//    
    ...
    public static int [][] matriz = { {  0,    2,   2,   3,   2,   3,   3,  3},//1
                                      {  2,    0,   2,   3,   2,   3,   1,  3},//2
                                      {  2,    2,   0,   3,   2,   1,   3,  3},//3
                                      {  3,    3,   3,   0,   1,   2,   2,  4},//4
                                      {  2,    2,   2,   1,   0,   3,   3,  3},//5
    ...
    public static void main(String[] args) {
       ...
       System.out.print("RECORRIDO EN PREORDEN => { ");
        ...
        for (int j = 0; j < recorridoPreorden.length-1; j++) {
            ...
            pesoTotal=pesoTotal+matriz[recorridoPreorden[j]][recorridoPreorden[j+1]];
       ...
       pesoTotal=pesoTotal+matriz[recorridoPreorden[recorridoPreorden.length-1]][0];
        System.out.print(" PESO TOTAL => "+pesoTotal);
